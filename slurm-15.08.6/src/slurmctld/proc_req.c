...
extern void inline slurm_free_sim_helper_msg(sim_helper_msg_t *msg);
#endif
...
#ifdef SLURM_SIMULATOR
       info("SIM: Processing RPC: MESSAGE_EPILOG_COMPLETE for jobid %d",
					epilog_msg->job_id);
...
#ifdef SLURM_SIMULATOR
	launch_msg_ptr->duration = job_desc_msg->duration;
#endif
